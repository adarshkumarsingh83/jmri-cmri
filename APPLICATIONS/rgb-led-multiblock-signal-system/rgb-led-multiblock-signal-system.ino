...
#define  G1_LED 2 // Green Signal 1 is digital pin 2
#define  R1_LED 3// Red Signal 1 is digital pin 4
#define  G2_LED 4// Green Signal 2 is digital pin 5
#define  R2_LED 5 //Red Signal 2 is digital pin 7
#define  blockOccSignal 6 // The transmit pin for the previous and next block in the sequence
