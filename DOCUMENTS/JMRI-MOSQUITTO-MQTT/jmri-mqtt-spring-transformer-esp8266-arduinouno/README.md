...
> node wise topics for each esp8266 node will have only relevant data only this will reduce the processing on the esp8266 \
> so that it can handle node specific data properly. \
